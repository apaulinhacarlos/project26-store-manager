...
Neste projeto eu desenvolvi minha primeira API utilizando a arquitetura MSC!
...
```bash
git clone git@github.com:apaulinhacarlos/project26-store-manager.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd project26-store-manager
```
